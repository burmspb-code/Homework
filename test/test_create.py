...
def test_get_mask_with_separator():
...
def test_get_mask_missing_arguments():
    # Проверка: отсутствие обязательных аргументов
    with pytest.raises(TypeError):
        # Передаем только 1 аргумент вместо 6
        get_mask("12345")

def test_get_mask_negative_separator_step():
