...
def test_get_json_data_success(mock_file):
...
def test_get_json_data_file_not_found(mock_file):
...
def test_get_json_data_invalid_json(mock_file):
...
def test_get_json_data_not_a_list(mock_file):
